...
class AppStore extends Component {
  ...
  render() {
    const {uniqueTabId, searchInput} = this.state
    const categoryWiseList = appsList.filter(
      apps =>
        apps.category === uniqueTabId &&
      ...
      <div className="App-store-container">
        ...
        <div className="search-container">
          <input
            ...
            type="search"
            onChange={this.filteredSearchResults}
            placeholder="Search"
          />
          <img
        ...
        <ul className="tabItem-container">
          {tabsList.map(item => (
            <TabItem
              ...
              key={item.tabId}
              activeTab={item.tabId === uniqueTabId}
            />
          ))}
        </ul>
        <ul className="appList-container">
          {categoryWiseList.map(appDetails => (
